...
7. npm install socket.io-client --save
8. ng generate service socket
9. npm install formidable --save
10. npm i process
11. npm install --save-dev jasmine-spec-reporter ts-node protractor
12. npx webdriver-manager update
